...
class Argument
{
     ...
     *
     * @param \Notadd\Foundation\Image\Commands\AbstractCommand $command
     * @param int                                               $key
     */
    ...
    public function required()
    {
        if (!array_key_exists($this->key, $this->command->arguments)) {
            throw new InvalidArgumentException(sprintf('Missing argument %d for %s', $this->key + 1,
                $this->getCommandName()));
        }
